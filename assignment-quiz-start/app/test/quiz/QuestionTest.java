...
public class QuestionTest {
	...
	public void openQuestionTest() {
		Question q = new OpenQuestions("What is the best kind of pancake?", "Spinach and goat cheese", 2);
	...
	public void thisThatQuestionTest() {
		Question q = new ThisOrThatQuestion("Are you hungry?", "yes", "no", 0, 1);
	...
	public void scoreBelowOneTest() {
		Question q = new OpenQuestions("Are you hungry?", "yes", -1);
		assertEquals(3, q.getScore());
	}

	@Test
	public void scoreAboveFiveTest() {
		Question q = new OpenQuestions("Are you hungry?", "yes", 1000);
		assertEquals(3, q.getScore());
	}
